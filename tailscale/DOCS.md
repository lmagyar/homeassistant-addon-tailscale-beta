...
balancing and failover is not possible with the current add-on behaviour.
...
> **Client** &#8658; _Internet_ &#8658; **Tailscale Funnel** (TCP proxy) &#8658; > _VPN_ &#8658; **Tailscale Proxy** (HTTPS proxy) &#8594; **HA** (HTTP
> web-server)
